...
export function PresencePanel(){
 ...
 const runAgent=()=>{
   s.startAgent(); const r0=s.canonicalRevision
   const queue=[
 ...
 const takeOver=()=>{s.claimSurface('tablet','human','edit');s.pauseAgent()}
